...
export const MEAL_POOL: PoolMeal[] = [
  ...
  /* ── ADDED VARIETY: high-protein, non-paneer ─────────────────────────── */
  {
    name: "Moong Dal & Methi Thepla", mealType: "breakfast",
    description: "Soft Gujarati theplas made with moong dal flour and fenugreek — protein-packed, travel-friendly, great with curd.",
    calories: 360, protein: 18, carbs: 44, fat: 12, fiber: 7, prepTime: 25,
    ingredients: ["½ cup moong dal flour", "½ cup wheat flour", "1 cup chopped methi (fenugreek)", "2 tbsp curd", "Turmeric, chilli powder, cumin", "1 tbsp oil", "Salt"],
    instructions: ["Mix both flours, methi, curd, spices and salt into a soft dough with a little water.", "Divide and roll into thin theplas.", "Cook on a hot tawa with a little oil until golden spots appear on both sides.", "Serve warm with curd or pickle."],
    tags: ["Indian", "High Protein", "Meal Prep"], allergens: ["gluten", "dairy"], conditionFlags: [],
    image: "https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=600&h=400&fit=crop&q=80",
  },
  {
    name: "Sattu Paratha", mealType: "breakfast",
    description: "Bihari stuffed paratha filled with spiced roasted gram flour (sattu) — one of the highest-protein Indian breakfasts, no dairy needed.",
    calories: 420, protein: 20, carbs: 56, fat: 13, fiber: 9, prepTime: 25,
    ingredients: ["1 cup wheat flour", "6 tbsp sattu (roasted gram flour)", "1 tbsp mustard oil", "Ajwain, chopped green chilli, ginger", "Lemon juice, salt", "Coriander"],
    instructions: ["Knead wheat flour into a soft dough, rest 15 min.", "Mix sattu with oil, ajwain, chilli, ginger, lemon and salt into a crumbly filling.", "Stuff dough balls with the sattu mix, seal and roll gently.", "Roast on a tawa with a little oil until crisp and golden."],
    tags: ["Indian", "High Protein", "Vegan"], allergens: ["gluten"], conditionFlags: [],
    image: "https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?w=600&h=400&fit=crop&q=80",
  },
  {
    name: "Tofu Bhurji", mealType: "main",
    description: "Crumbled tofu cooked like a masala bhurji with onion, tomato and turmeric — a dairy-free stand-in for paneer bhurji, just as satisfying.",
    calories: 340, protein: 24, carbs: 16, fat: 20, fiber: 4, prepTime: 20,
    ingredients: ["200g firm tofu, crumbled", "1 onion, 1 tomato, finely chopped", "1 green chilli", "Turmeric, cumin, garam masala", "1 tbsp oil", "Coriander"],
    instructions: ["Heat oil, sauté onion and chilli until soft.", "Add tomato and dry spices, cook to a masala.", "Add crumbled tofu, mix well, cook 6-8 min.", "Finish with garam masala and coriander. Serve with roti."],
    tags: ["Indian", "High Protein", "Vegan"], allergens: ["soy"], conditionFlags: [],
    image: "https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=600&h=400&fit=crop&q=80",
    jain: true,
  },
  {
    name: "Soya Chunk Keema Curry", mealType: "main",
    description: "Minced soya chunks simmered in a spiced onion-tomato gravy — a protein powerhouse that eats like keema, fully vegetarian.",
    calories: 380, protein: 30, carbs: 28, fat: 15, fiber: 8, prepTime: 30,
    ingredients: ["1 cup soya granules, soaked", "1 onion, 2 tomatoes, pureed", "1 tbsp ginger-garlic paste", "Peas (optional)", "Garam masala, chilli, turmeric", "1.5 tbsp oil", "Coriander"],
    instructions: ["Soak soya granules in hot water 10 min, squeeze dry.", "Fry onion until golden, add ginger-garlic, then tomato puree and spices.", "Cook until oil separates, add soya and peas with a little water.", "Simmer 12-15 min, finish with garam masala and coriander."],
    tags: ["Indian", "High Protein", "Vegan"], allergens: ["soy"], conditionFlags: [],
    image: "https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=600&h=400&fit=crop&q=80",
  },
  {
    name: "Rajma Masala with Rice", mealType: "main",
    description: "Red kidney beans in a rich Punjabi gravy over rice — the classic comfort combo that quietly delivers a big hit of plant protein and fibre.",
  ...
  },
  {
    ...
    description: "White chickpeas in a tangy tomato-onion masala with warm roti — cheap, filling, and loaded with protein and fibre.",
    calories: 430, protein: 18, carbs: 62, fat: 12, fiber: 13, prepTime: 30,
    ingredients: ["1 cup cooked chickpeas (chana)", "1 onion, 2 tomatoes", "1 tbsp ginger-garlic paste", "Chana masala, cumin, amchur", "1 tbsp oil", "2 rotis, coriander"],
    instructions: ["Fry cumin, onion until golden, add ginger-garlic.", "Add tomato and spices, cook to a thick masala.", "Add chickpeas with water, simmer 15 min.", "Finish with amchur and coriander; serve with roti."],
    tags: ["Indian", "High Protein", "Vegan"], allergens: ["gluten"], conditionFlags: [],
    image: "https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=600&h=400&fit=crop&q=80",
  },
  {
    name: "Sprouted Moong Chaat", mealType: "snack",
    description: "Crunchy sprouted moong tossed with onion, tomato, lemon and chaat masala — a raw, high-protein snack that takes five minutes.",
    calories: 180, protein: 14, carbs: 26, fat: 2, fiber: 8, prepTime: 8,
    ingredients: ["1.5 cups sprouted moong", "1 onion, 1 tomato, finely chopped", "Green chilli, coriander", "Lemon juice, chaat masala, salt", "Pomegranate (optional)"],
    instructions: ["Steam sprouts 3-4 min for easier digestion (or use raw).", "Toss with onion, tomato, chilli and coriander.", "Add lemon juice, chaat masala and salt.", "Top with pomegranate and serve fresh."],
    tags: ["Indian", "High Protein", "Vegan"], allergens: [], conditionFlags: [],
    image: "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600&h=400&fit=crop&q=80",
  },
  {
    name: "Besan Paratha with Curd", mealType: "breakfast",
    description: "Whole-wheat paratha stuffed with spiced gram flour — a protein-rich alternative to aloo paratha, served with a bowl of curd.",
    calories: 400, protein: 17, carbs: 52, fat: 14, fiber: 8, prepTime: 25,
    ingredients: ["1 cup wheat flour", "5 tbsp besan (gram flour)", "Ajwain, chilli, turmeric", "1 tbsp oil", "100g curd", "Salt, coriander"],
    instructions: ["Knead a soft wheat dough, rest 15 min.", "Dry-roast besan 2 min, mix with spices, coriander and a little oil.", "Stuff dough balls with the besan mix, roll gently.", "Roast on a tawa with oil until golden. Serve with curd."],
    tags: ["Indian", "High Protein", "Vegetarian"], allergens: ["gluten", "dairy"], conditionFlags: [],
    image: "https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?w=600&h=400&fit=crop&q=80",
  }
];
