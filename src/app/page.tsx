...
const features = [
  ...
  { href: "/meal-planner", tag: "One click", title: "Weekly Meal Planner", desc: "Your whole week of vegetarian meals, built to hit your macro targets — with a shopping list that follows." },
